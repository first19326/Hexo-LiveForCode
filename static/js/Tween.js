var mouseX = mouseY = mouseOldX = mouseOldY = 0,
                    ...
                    triW = window.config.ArticleHeaderAnimation.triW,
                    triH = window.config.ArticleHeaderAnimation.triH,
                    neighbours = window.config.ArticleHeaderAnimation.neighbours,
                    speedTrailAppear = window.config.ArticleHeaderAnimation.speedTrailAppear,
                    speedTrailDisappear = window.config.ArticleHeaderAnimation.speedTrailDisappear,
                    speedTriOpen = window.config.ArticleHeaderAnimation.speedTriOpen,
                    trailMaxLength = window.config.ArticleHeaderAnimation.trailMaxLength,
                    trailIntervalCreation = window.config.ArticleHeaderAnimation.trailIntervalCreation,
                    delayBeforeDisappear = window.config.ArticleHeaderAnimation.delayBeforeDisappear,
                    cols, rows,
                    tris,
                    randomAlpha = true,

                    colors = window.config.ArticleHeaderAnimation.colors;
