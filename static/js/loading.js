 ...
 */
var loading = {
    settings: window.config.Loading,
    ...
    initRebound: function initRebound() {
        ...
        var settings = loading.settings.rebound;

        // Create a SpringSystem.
        var springSystem = new rebound.SpringSystem();

        // Add a spring to the system.
        loading.spring = springSystem.createSpring(settings.tension, settings.friction);
    },
    ...
    initSpinner: function initSpinner() {
        ...
        var settings = loading.settings.spinner;

        // Instantiate Spinner.
        loading.spinner = new Spinner(settings);
    },
    ...
    init: function init() {
        ...
        loading.spinner.init(loading.spring, spinnerTypeAutoSpin);
    ...
    loadSomething: function loadSomething() {
        ...
        oReq.addEventListener('progress', function (oEvent) {
            if (oEvent.lengthComputable) {
                ...
                loading.spring.setEndValue(percent * 0.01);
            }
        });
